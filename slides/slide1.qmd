...
## Case study: survival on titanic {.scrollable background-color="#F5EDDE"}
...
- Logistic regression can be used to model binary or proportion (out of total cases) responses.
